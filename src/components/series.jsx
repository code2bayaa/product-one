...
import COUNTRIES from "../midlleware/countries"
// import Slider from "react-slick";

const SERIES = () => {

    // const hasFetched = useRef({country:false,init:false,countries:false})
    ...
    useEffect(() => { 
        // if(hasFetched.current.init){
        //     return
        // }
        // hasFetched.current.init = true
  ...
  const navRoute = ({state,url}) => {
    ...
    const loadComponent = () => {
        ...
        if(movies){
            return (
                <>
                    <COUNTRIES fetchMovies={fetchMovies} mutateInsertMovies={mutateInsertMovies} mode={'tv'}/>
                    {
